...
export function UserMessage({ content, parts }: UserMessageProps) {
  ...
  if (Array.isArray(content)) {
    ...
    return (
      <div className="overflow-hidden flex flex-col gap-3 items-center ">
        ...
        <div className="flex flex-col gap-2.5 bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor backdrop-blur-sm px-3 py-2.5 w-auto rounded-lg mr-auto">
  ...
  return (
    <div className="flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor backdrop-blur-sm px-3.5 py-2.5 w-auto rounded-lg ml-auto">
