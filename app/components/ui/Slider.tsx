...
export const Slider = genericMemo(<T,>({ selected, options, setSelected }: SliderProps<T>) => {
  ...
  return (
    <div className="flex items-center flex-wrap shrink-0 gap-1 bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor overflow-hidden rounded-full p-1">
  ...
  return (
    <button
      ...
      className={classNames(
        'bg-transparent text-xs px-2.5 py-1 rounded-full relative',
        selected
