...
export function TabsWithSlider({
  ...
  return (
    <div className={classNames('relative flex gap-2', className)}>
      ...
      {tabs.map((tab, index) => (
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ? classNames('text-white shadow-sm shadow-builders-brand-primary/20', activeTabClassName)
              : classNames(
                  'bg-bolt-elements-background-depth-2 dark:bg-bolt-elements-background-depth-3 text-bolt-elements-textPrimary hover:bg-bolt-elements-background-depth-3 dark:hover:bg-bolt-elements-background-depth-4 border border-bolt-elements-borderColor',
                  tabClassName,
                ),
          )}
        >
      ...
      <motion.div
        className={classNames(
          'absolute bottom-0 left-0 h-10 rounded-lg bg-builders-brand-primary -z-10',
          sliderClassName,
        )}
        initial={false}
        animate={{
